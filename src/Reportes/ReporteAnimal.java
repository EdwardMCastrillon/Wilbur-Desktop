...
public class ReporteAnimal {
    ...
    public void crearInformeTabla(String tabla,String campo,ListaAnimal P) 
    {
      ...
      {      
	    ...
	    // Se asocia el raza al OutputStream y se indica que el espaciado entre
	    // lineas sera de 20. Esta llamada debe hacerse antes de abrir el raza
	    PdfWriter.getInstance(documento,ficheroPdf).setInitialLeading(20);
	    // Se abre el raza.
	    documento.open();
	    //INSETAR objetos al raza
	    documento.add( crearTitulo( "Tabla "+ tabla));// inserta el titulo
	    documento.add(new Paragraph(" "));//para dar un salto de linea
	//  raza.add(obtenerImagen("images.jpg"));// inserta una imagen que se llama images.jpg
	 ...
	 public Paragraph crearTitulo(String titulo)
     {
	  ...
	  public PdfPTable tablaDatos()
	  {
	          ...
	          String codigo, raza, peso, sexo, codigoMadre;
	          ...
	          PdfPCell celda;
	            ...
	            while(Nodo != null) // recorre cada registro del resultset
	            {
	            	...
	            	peso = Nodo.getAnimal().getPeso_destete();
	            	sexo = Nodo.getAnimal().getSexo();
                        codigoMadre = Nodo.getAnimal().getCod_madre();
